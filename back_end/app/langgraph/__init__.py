...
class PatentReportGenerator:
    ...
    async def _generate_summary(self, state: PatentAnalysisState) -> PatentAnalysisState:
        try:
            summary_prompt = f"""
...
"""
    ...
    async def generate_report(self, topic: str, patent_ids: List[str] = None) -> Dict[str, Any]:
